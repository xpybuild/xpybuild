...
class Custom(BaseTarget): # deprecated because error handling/logging is poor and it promotes bad practices like not using options (e.g process timeout)
	...
	def __init__(self, target, deps, fn, cleanfn=None):
		...
		cleanfn -- The functor used to clean this target (optional, defaults to removing 
			the target file/dir)
		"""
...
class CustomCommand(BaseTarget):
	...
	def __init__(self, target, command, dependencies, cwd=None, redirectStdOutToTarget=False, env=None, stdout=None, stderr=None):
		...
		target -- the file or directory to be built. Will be cleaned, and its parent dir created, 
			before target runs. 
		deps -- an optional list of dependencies; it is essential that ALL dependencies generated by 
			the build process are explicitly listed here
		command -- a function or a list. 
		...
		cwd -- the working directory to run it from (almost always this should be 
		...
		stdout -- usually a unique name is auto-generated for .out for this target, but 
			use this if requried to send output to a specific location. 
		stderr -- usually a unique name is auto-generated for .err for this target, but 
			use this if requried to send output to a specific location. 
		"""
...
class CustomCommandWithCopy(CustomCommand, Copy):
	...
	def __init__(self, target, command, dependencies, copySrc, cwd=None, redirectStdOutToTarget=False, env=None):
		...
		dependencies -- an explicit list of any dependencies (other than copySrc) 

...
-  Jar: manifest creation (create\_manifest) was in some cases
...
-  Pathsets: A new pathset called TargetsWithinDir has been added. This
   is similar to TargetsWithTag but uses just a parent directory name to
